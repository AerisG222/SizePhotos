...
namespace SizePhotos
{
    public class ExifData
    {
        ...
        public string ExposureDifference { get; set; }
        ...
        public string HyperfocalDistance { get; set; }
        ...
        public string ScaleFactor35Efl { get; set; }
        ...
        public string ShotTakenDate { get; set; }
